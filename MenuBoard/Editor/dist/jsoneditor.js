...
(function () {
    ...
    JSONEditor.prototype = {
        ...
        init: function () {
            ...
            this.__data = {};
            debugger;
            this.storageUrl = this.options.storage_explorer_url;
        ...
        afterInputReady: function () {
            ...
            if (this.storage) {
                if (this.storage) {
                    ...
                    var openUrl = this.jsoneditor.storageUrl + "?name=" + id;

                    var btn = $('<input type="button" href="' + openUrl + '" value="파일 선택" />');
                    $(this.input).after($(btn));

                    //Azure Storage Explorer 화면을 띄운다.
                    var frame = $(btn).magnificPopup({
                        type: 'iframe',
                    });
